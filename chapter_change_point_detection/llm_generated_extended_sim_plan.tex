...
\textbf{Placeholder figure B1: Bernoulli change-point task.}
...
\textbf{Placeholder figure B2: BOCPD internals.}
...
\textbf{Placeholder figure B3: finite pathway approximation.}
Panel A: latent \(\theta_t\), observations, and exact BOCPD prediction. Panel B: estimates \(\hat\theta_t^{(k)}\) for fast, intermediate, and slow pathway-like learners. Panel C: readout weights \(w_t^{(k)}\), shifting toward fast learners after change and slow learners during stability. Panel D: mixture prediction compared with exact BOCPD. Panel E: predictive loss for one fixed learning rate, finite pathway bank, Wilson-style reduced mixture if implemented, and exact BOCPD.
\end{minipage}}
\caption{A finite bank of fixed-timescale learners as a pathway-like approximation to BOCPD. This is the minimal additional simulation most directly connected to PPT.}
