...
% CHAPTER about ``Aims and contributions of this thesis'' (see Laura's thesis)
% - Show on 2-3 pages the storyline of the entire thesis, also good place to mention publications not included in the thesis.

%%% PART I: Feedforward / hetero-associative / feedforward memory consolidation: Parallel Pathway Theory

\cfchapter{
  Aims and contributions of this thesis
  \label{ch:aims}
}{chapter_aims_and_contributions}{aims_and_contributions}
...
%% CHAPTER SEMANTIZATION NOW IN Chapter 2
%%\tikzsetexternalprefix{./3/TikzPictures/}
%\cfchapter{
%  Episodic to semantic memory transformation in the parallel pathways theory (PPT)
%  \label{ch:ppt-semantization}
%}{chapter_PPT_semantization}{main}

%%% PART II: Bayesian change point detection in dynamic environments

% CHAPTER 3
\cfchapter{
  Area-specific semantic generalizations in the parallel pathway theory (PPT) enable Bayes-optimal statistical learning in changing environments
  \label{ch:change-point-detection}
}{chapter_change_point_detection}{main}

% CHAPTER CALB1 kicked out
%\cfchapter{
%  Cognitive flexibility in changing environments: The role of calbindin-containing CA1 pyramidal cells during learning and consolidation
%  \label{ch:calb-ca1}
%}{chapter_calb_ca1}{main}

%%% PART III: Recurrent / auto-associative systems memory consolidation

% CHAPTER 4
%\tikzsetexternalprefix{./5/TikzPictures/}
\cfchapter{
  Memory consolidation in Drosophila: From parallel pathways to recurrent engram dynamics
  \label{ch:drosophila}
}{chapter_drosophila}{main}

% CHAPTER 5
%\tikzsetexternalprefix{./6/TikzPictures/}
\cfchapter{
  Distributed engram reorganization: A dynamical systems perspective for systems consolidation and representational drift
  \label{ch:engram-reorganization}
}{chapter_engram_dynamics}{main}
