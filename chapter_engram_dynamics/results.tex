...
\begin{figure}
  ...
  \centerwidegraphic[width=6.5in]{figures/fig1.pdf}
  \caption{
...
\begin{figure}
  \centering
  % 6.5in is the width set in the Google Slides page setup
  \centerwidegraphic[width=6.5in]{figures/fig2.pdf}
  \caption{
...
\todo{Do we want more here? Math + sims as Henning once suggested? From Henning: Math on how to split this up and some simulations. I suspect that M\_potent is obtained by projecting all columns onto the set of readout vectors. Whatever remains it M\_null.}
...
\begin{figure}
  \centering
  % 4.49in is 2/3 col figure width (11.4cm) in Cell press
  \centerwidegraphic[width=4.49in]{figures/fig3.pdf}
  \caption{
...
\begin{figure}
  \centering
  % 6.5in is the width set in the Google Slides page setup
  \centerwidegraphic[width=6.5in]{figures/fig4.pdf}
  \caption{
...
\begin{figure}%[H]
  \centering
  % 6.5in is the width set in the Google Slides page setup
  \centerwidegraphic[width=6.5in]{figures/fig5.pdf}
  \caption{
