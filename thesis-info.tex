...
\title{Mechanisms and function of dynamic memory representations}
% subtitle can be let empty
\subtitle{From systems consolidation to representational drift}
%\subtitle{}
