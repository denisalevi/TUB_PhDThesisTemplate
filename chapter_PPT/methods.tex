...
learning rate, in keeping with the analytical result of \cite{Remme2021}
that STDP in the shortcut implements gradient descent on the mean squared
error between the two pathways' outputs.
