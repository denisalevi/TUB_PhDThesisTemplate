...
Our \replaced{results are }{theory is} in quantitative agreement with lesion studies of the perforant path in rodents \cite{Remondes2004} and \replaced{are }{is} able to reproduce forgetting curves that follow a power-law as observed in humans \cite{Wixted2004}.
...
Hence, our \replaced{theoretical framework }{theory} is also in agreement with the Multiple Trace Theory (MTT) \cite{Nadel1997} and the Trace Transformation Theory (TTT) \cite{Winocur2010, Winocur2011}.
